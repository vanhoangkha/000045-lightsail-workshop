...
![Lightsail](/images/1-deploy-infra/0030-accessdb.png?width=90pc)

2. Click **Manage**. 

![Lightsail](/images/1-deploy-infra/0031-accessdb.png?width=90pc)
...
![Lightsail](/images/1-deploy-infra/0032-accessdb.png?width=90pc)

4. Quay lại trang ứng dụng todo của chúng ta. Click **Settings**.
![Lightsail](/images/1-deploy-infra/0033-configuredb.png?width=90pc)
...
5. Tại mục **DB Hostname**, điền thông tin endpoint của **Todo-DB**.
  ...
  + Click **Save Settings**.
![Lightsail](/images/1-deploy-infra/0034-configuredb.png?width=90pc)

6. Ứng dụng sẽ tiến hành kiểm tra kết nối tới CSDL Lightsail.
![Lightsail](/images/1-deploy-infra/0035-connectsuccess.png?width=90pc)

7. Click **Add Task** và thêm task tùy ý. Các task tiếp theo bạn tạo sẽ được lưu vào trong CSDL Lightsail.
![Lightsail](/images/1-deploy-infra/0036-newtasklsdb.png?width=90pc)